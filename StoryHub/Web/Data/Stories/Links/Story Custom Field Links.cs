...
namespace Web.Data.Stories
{
    ...
    {
        /// <summary>
        /// Retrieve all story custom field link items from database for the specified story
        /// </summary>
        ...
        /// <summary>
        /// Retrieve all story custom field link items from database for the specified custom field
        /// </summary>
